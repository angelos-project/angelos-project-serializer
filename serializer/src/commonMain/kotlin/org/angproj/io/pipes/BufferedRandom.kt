...
class BufferedRandom(raw: RawIOBase, bufferSize: Int) : BufferedReader(raw, bufferSize) /*, BufferedWriter(raw, bufferSize)*/ {
    /*override fun peek(position: Long): Buffer {
