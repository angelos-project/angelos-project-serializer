...
object MetaProject {
     ...
     */
    const val artifact = "angelos-project-serializer"

    /**
     * Group ID for MavenCentral or similar.
     * Can be the root package of the project.
     */
    const val group = "org.angproj.io.serializer"
     ...
     */
    const val mavenName = "Serializer for Angelos Project™"

    /**
     * Long description for MavenCentral.
     */
    const val mavenDescription = "Kotlin serialization interface to the binary buffer used within Angelos™."

    /**
     * Maven scm url.
     */
    const val mavenScmUrl = "https://github.com/angelos-project/angelos-project-serializer.git"

    /**
     * Maven scm connection.
     */
    const val mavenScmConnection = "scm:git:git://github.com/angelos-project/angelos-project-serializer.git"

    /**
     * Maven scm developer connection.
     */
    const val mavenScmDeveloperConnection = "scm:git:git://github.com/angelos-project/angelos-project-serializer.git"
     ...
     * Issue management.
     */
    const val issueManagement = "https://github.com/angelos-project/angelos-project-serializer/issues"

    /**
     * Project native repository.
     */
    const val homeRepo = "https://github.com/angelos-project/angelos-project-serializer"
