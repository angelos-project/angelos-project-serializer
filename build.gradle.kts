...
coverallsJacoco {
    ...
    reportSourceSets = listOf(
        File("$projectDir/serializer/src/commonMain/kotlin/"),
        File("$projectDir/serializer/src/jvmMain/kotlin/"),
        File("$projectDir/serializer/src/jsMain/kotlin/"),
        File("$projectDir/serializer/src/nativeMain/kotlin/"),
    )
}